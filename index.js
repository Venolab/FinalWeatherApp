...
function displayForecast(response) {
  ...
  let days=["thr","fri","sat","sun","Mon",]
  days.forEach(function(day){
    forecastHTML= forecastHTML +`<div class="container" id="forcast">
          <div class="row">
            <div class="col-2">
              <div class="forecast-day">${day}</div>
              <img src="http://openweathermap.org/img/wn/${response.data.weather[0].icon}@2x.png" alt=""width42px />
              <div class="forecast-temperature">
                <span class="forecast-temperature=min"> 27°</span>
